...
class CONFIG:
    osm_bike_params = {
       ...
       'bike_cyclewaylane': {'network_type':'bike', 'custom_filter': '["cycleway"~"lane"]', 'retain_all': True},
       'bike_cyclewaytrack': {'network_type':'bike', 'custom_filter':'["cycleway"~"track"]', 'retain_all': True},
       'bike_highwaycycleway': {'network_type':'all', 'custom_filter':'["highway"~"cycleway"]',  'retain_all': True},
       ...
       'bike_sharrow':  {'network_type':'bike', 'custom_filter':'["cycleway"~"shared_lane"]', 'retain_all': True},
       'bike_livingstreet': {'network_type':'bike', 'custom_filter':'["highway"~"living_street"]', 'retain_all': True}}
        
    osm_carall_params = {'carall': {'network_type':'drive', 'custom_filter': None, 'retain_all': False}} 
